...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_bdk_ddbc_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_bdk_ddbc_rustbuffer_free(self, $0) }
    }
}
...
public class Address: AddressProtocol {
    ...
    bdk_ddbc_Address_new(
        FfiConverterString.lower(`address`), $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_Address_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_Address_payload(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Address_network(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Address_script_pubkey(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Address_to_qr_uri(self.pointer, $0
    )
}
        )
    }
...
public class Blockchain: BlockchainProtocol {
    ...
    bdk_ddbc_Blockchain_new(
        FfiConverterTypeBlockchainConfig.lower(`config`), $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_Blockchain_object_free(pointer, $0) }
    }
    ...
    public func `broadcast`(`transaction`: Transaction) throws {
        try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Blockchain_broadcast(self.pointer, 
    ...
    public func `estimateFee`(`target`: UInt64) throws -> FeeRate {
        return try FfiConverterTypeFeeRate.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Blockchain_estimate_fee(self.pointer, 
    ...
    public func `getHeight`() throws -> UInt32 {
        return try FfiConverterUInt32.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Blockchain_get_height(self.pointer, $0
    )
}
        )
    }
    public func `getBlockHash`(`height`: UInt32) throws -> String {
        return try FfiConverterString.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Blockchain_get_block_hash(self.pointer, 
...
public class BumpFeeTxBuilder: BumpFeeTxBuilderProtocol {
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_BumpFeeTxBuilder_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_BumpFeeTxBuilder_allow_shrinking(self.pointer, 
        FfiConverterString.lower(`address`), $0
    )
}
        )
    ...
    bdk_ddbc_BumpFeeTxBuilder_enable_rbf(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_BumpFeeTxBuilder_enable_rbf_with_sequence(self.pointer, 
    ...
    public func `finish`(`wallet`: Wallet) throws -> PartiallySignedTransaction {
        return try FfiConverterTypePartiallySignedTransaction.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_BumpFeeTxBuilder_finish(self.pointer, 
...
public class DerivationPath: DerivationPathProtocol {
    ...
    bdk_ddbc_DerivationPath_new(
        FfiConverterString.lower(`path`), $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_DerivationPath_object_free(pointer, $0) }
    }
...
public class Descriptor: DescriptorProtocol {
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_Descriptor_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_Descriptor_new_bip44_public(
    ...
    bdk_ddbc_Descriptor_new_bip49_public(
        FfiConverterTypeDescriptorPublicKey.lower(`publicKey`), 
        FfiConverterString.lower(`fingerprint`), 
        FfiConverterTypeKeychainKind.lower(`keychain`), 
        FfiConverterTypeNetwork.lower(`network`), $0)
    ...
    bdk_ddbc_Descriptor_new_bip84_public(
        FfiConverterTypeDescriptorPublicKey.lower(`publicKey`), 
        FfiConverterString.lower(`fingerprint`), 
        FfiConverterTypeKeychainKind.lower(`keychain`), 
        FfiConverterTypeNetwork.lower(`network`), $0)
    ...
    bdk_ddbc_Descriptor_as_string(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Descriptor_as_string_private(self.pointer, $0
    )
}
        )
    }
...
public class DescriptorPublicKey: DescriptorPublicKeyProtocol {
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_DescriptorPublicKey_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_DescriptorPublicKey_from_string(
    ...
    public func `derive`(`path`: DerivationPath) throws -> DescriptorPublicKey {
        return try FfiConverterTypeDescriptorPublicKey.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_DescriptorPublicKey_derive(self.pointer, 
    ...
    public func `extend`(`path`: DerivationPath) throws -> DescriptorPublicKey {
        return try FfiConverterTypeDescriptorPublicKey.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_DescriptorPublicKey_extend(self.pointer, 
        FfiConverterTypeDerivationPath.lower(`path`), $0
    )
}
        )
    ...
    bdk_ddbc_DescriptorPublicKey_as_string(self.pointer, $0
    )
}
        )
    }
...
public class DescriptorSecretKey: DescriptorSecretKeyProtocol {
    ...
    bdk_ddbc_DescriptorSecretKey_new(
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_DescriptorSecretKey_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_DescriptorSecretKey_from_string(
    ...
    public func `derive`(`path`: DerivationPath) throws -> DescriptorSecretKey {
        return try FfiConverterTypeDescriptorSecretKey.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_DescriptorSecretKey_derive(self.pointer, 
        FfiConverterTypeDerivationPath.lower(`path`), $0
    )
}
        )
    ...
    public func `extend`(`path`: DerivationPath) throws -> DescriptorSecretKey {
        return try FfiConverterTypeDescriptorSecretKey.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_DescriptorSecretKey_extend(self.pointer, 
        FfiConverterTypeDerivationPath.lower(`path`), $0
    )
}
        )
    ...
    bdk_ddbc_DescriptorSecretKey_as_public(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_DescriptorSecretKey_secret_bytes(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_DescriptorSecretKey_as_string(self.pointer, $0
    )
}
        )
    }
...
public class FeeRate: FeeRateProtocol {
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_FeeRate_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_FeeRate_from_sat_per_vb(
    ...
    bdk_ddbc_FeeRate_as_sat_per_vb(self.pointer, $0
    )
}
        )
    }
...
public class Mnemonic: MnemonicProtocol {
    ...
    bdk_ddbc_Mnemonic_new(
        FfiConverterTypeWordCount.lower(`wordCount`), $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_Mnemonic_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_Mnemonic_from_entropy(
    ...
    bdk_ddbc_Mnemonic_as_string(self.pointer, $0
    )
}
        )
    }
...
public class PartiallySignedTransaction: PartiallySignedTransactionProtocol {
    ...
    bdk_ddbc_PartiallySignedTransaction_new(
        FfiConverterString.lower(`psbtBase64`), $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_PartiallySignedTransaction_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_PartiallySignedTransaction_serialize(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_PartiallySignedTransaction_txid(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_PartiallySignedTransaction_extract_tx(self.pointer, $0
    )
}
        )
    }
    public func `combine`(`other`: PartiallySignedTransaction) throws -> PartiallySignedTransaction {
        return try FfiConverterTypePartiallySignedTransaction.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_PartiallySignedTransaction_combine(self.pointer, 
    ...
    bdk_ddbc_PartiallySignedTransaction_fee_amount(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_PartiallySignedTransaction_fee_rate(self.pointer, $0
    )
}
        )
    }
...
public class Script: ScriptProtocol {
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_Script_object_free(pointer, $0) }
    }
...
public class Transaction: TransactionProtocol {
    ...
    bdk_ddbc_Transaction_new(
        FfiConverterSequenceUInt8.lower(`transactionBytes`), $0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_Transaction_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_Transaction_txid(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_weight(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_size(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_vsize(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_serialize(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_is_coin_base(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_is_explicitly_rbf(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_is_lock_time_enabled(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_version(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_lock_time(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_input(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_Transaction_output(self.pointer, $0
    )
}
        )
    }
...
public class TxBuilder: TxBuilderProtocol {
    ...
    bdk_ddbc_TxBuilder_new($0)
})
    }

    deinit {
        try! rustCall { ffi_bdk_ddbc_TxBuilder_object_free(pointer, $0) }
    }
    ...
    bdk_ddbc_TxBuilder_add_recipient(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_add_unspendable(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_add_utxo(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_add_utxos(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_do_not_spend_change(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_TxBuilder_manually_selected_only(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_TxBuilder_only_spend_change(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_TxBuilder_unspendable(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_fee_rate(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_fee_absolute(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_drain_wallet(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_TxBuilder_drain_to(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_enable_rbf(self.pointer, $0
    )
}
        )
    }
    ...
    bdk_ddbc_TxBuilder_enable_rbf_with_sequence(self.pointer, 
        FfiConverterUInt32.lower(`nsequence`), $0
    )
}
        )
    ...
    bdk_ddbc_TxBuilder_add_data(self.pointer, 
    ...
    bdk_ddbc_TxBuilder_set_recipients(self.pointer, 
    ...
    public func `finish`(`wallet`: Wallet) throws -> TxBuilderResult {
        return try FfiConverterTypeTxBuilderResult.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_TxBuilder_finish(self.pointer, 
        FfiConverterTypeWallet.lower(`wallet`), $0
    )
}
        )
...
public class Wallet: WalletProtocol {
    ...
    deinit {
        try! rustCall { ffi_bdk_ddbc_Wallet_object_free(pointer, $0) }
    }
    ...
    public func `getAddress`(`addressIndex`: AddressIndex) throws -> AddressInfo {
        return try FfiConverterTypeAddressInfo.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_get_address(self.pointer, 
    ...
    public func `getInternalAddress`(`addressIndex`: AddressIndex) throws -> AddressInfo {
        return try FfiConverterTypeAddressInfo.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_get_internal_address(self.pointer, 
        FfiConverterTypeAddressIndex.lower(`addressIndex`), $0
    )
}
        )
    ...
    public func `getBalance`() throws -> Balance {
        return try FfiConverterTypeBalance.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_get_balance(self.pointer, $0
    )
}
        )
    }
    public func `sign`(`psbt`: PartiallySignedTransaction, `signOptions`: SignOptions?) throws -> Bool {
        return try FfiConverterBool.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_sign(self.pointer, 
    ...
    public func `listTransactions`(`includeRaw`: Bool) throws -> [TransactionDetails] {
        return try FfiConverterSequenceTypeTransactionDetails.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_list_transactions(self.pointer, 
    ...
    bdk_ddbc_Wallet_network(self.pointer, $0
    )
}
        )
    }
    public func `sync`(`blockchain`: Blockchain, `progress`: Progress?) throws {
        try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_sync(self.pointer, 
    ...
    public func `listUnspent`() throws -> [LocalUtxo] {
        return try FfiConverterSequenceTypeLocalUtxo.lift(
            try
    rustCallWithError(FfiConverterTypeBdkError.self) {
    bdk_ddbc_Wallet_list_unspent(self.pointer, $0
    )
}
        )
    }
...
fileprivate struct FfiConverterCallbackInterfaceProgress {
    ...
    private static func initCallback() {
        try! rustCall { (err: UnsafeMutablePointer<RustCallStatus>) in
                ffi_bdk_ddbc_Progress_init_callback(foreignCallbackCallbackInterfaceProgress, err)
        }
    }
